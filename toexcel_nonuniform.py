...
restored_image_dir = r"E:\CV\Code\Deblur_MCEM\results\Lai\all"
gt_image_dir = r"E:\CV\dataset\deblur\Lai\synthetic_dataset\ground_truth"

data = []  # 存储结果数据

for filename in os.listdir(restored_image_dir):
    ...
    try:
        ...
        psnr = round(output[0], 2)  # PSNR保留2位小数
        ssim = round(output[1], 3)  # SSIM保留3位小数
    except Exception as e:
...
# 写入Excel文件
excel_path = "lai_nonuniform.xlsx"
sheet_name = "MCEM"
